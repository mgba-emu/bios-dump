...
#define GetBe32(p) __builtin_bswap32(*(const u32 *)(const u8 *)(p))
#define GetBe64(p) __builtin_bswap64(*(const u64 *)(const u8 *)(p))
#define SetBe32(p, v) (*(u32 *)(void *)(p)) = __builtin_bswap32(v)
...
void Sha256_Final(CSha256 *p, u8 *digest)
{
  ...
  {
    u64 numBits = (p->count << 3);
    SetBe32(p->buffer + 64 - 8, (u32)(numBits >> 32));
    SetBe32(p->buffer + 64 - 4, (u32)(numBits));
  }
